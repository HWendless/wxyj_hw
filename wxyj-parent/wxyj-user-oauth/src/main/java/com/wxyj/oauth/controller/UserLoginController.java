...
public class UserLoginController {
    ...
    public Result<Map> login(String username, String password) throws UnsupportedEncodingException {
        //登录 之后生成令牌的数据返回
